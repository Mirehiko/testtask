...
SECRET_KEY = 'n(d9q()83vzmm^eeyz!((=4liie)8ef&4@mfe)6v-xl*^))r*k'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'taskproject.context_processors.site_processor',

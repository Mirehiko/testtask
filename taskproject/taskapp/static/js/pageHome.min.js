...
function drawTaskList(data) {
    ...
    for (let taskid in data) {
        // taskList[task] = new TaskListView(data[task]);
...
function fillTaskList(data) {
    ...
    for (let taskid in data) {
        ...
        // taskList[taskid] = new TaskListView(data[taskid]);
    }
}
...
function confirmTask() {
    const taskid = $(this).attr('taskid');
    if (taskList[taskid].data.is_cofirmed) {
        taskList[taskid].data.is_cofirmed = false;
        console.log('toFalse', taskList[taskid].data.is_cofirmed)
    }
    else {
        taskList[taskid].data.is_cofirmed = true;
        console.log('toTrue', taskList[taskid].data.is_cofirmed)
    }
    Task.update(taskList[taskid].data);
}

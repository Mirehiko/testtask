  ...
  _createClass(Paginator, [{
    ...
    value: function init() {
      ...
      this.prevBtn.on("click", function (e) {
        e.preventDefault();
        Task.getPage(_this.prevPage);
      });
      this.nextBtn.on("click", function (e) {
        e.preventDefault();
        Task.getPage(_this.nextPage);
      });
    }
  }, {
    key: "setData",
  ...
  _createClass(TaskForm, [{
    ...
    value: function init(params) {
      ...
      this.confirmBtn.on("click", function (e) {
        ...
        data["user"] = _this2.formTaskUserName.val();
        data["email"] = _this2.formTaskEmail.val();
        data["title"] = _this2.formTaskTitle.val();
        data["description"] = _this2.formTaskDescription.val();
    ...
    value: function setFormData(data) {
      this.data = data; // console.log('formdata', this.data)
...
var TaskForms = /*#__PURE__*/function () {
  function TaskForms() {
    ...
    value: function init() {
      ...
      if (is_authorized) {
        ...
        this.taskEdit.on("click", function () {
          ...
          taskUpdateForm.setFormData(_this3.data);
          taskUpdateForm.show();
        });
      }
